...
int fn_NetSim_DSR_GeneralPacketProcessing(NetSim_EVENTDETAILS* pstruEventDetails)
{
	...
	pstruEventDetails->pPacket->pstruNetworkData->szGatewayIP = IP_COPY(DSR_DEV_IP(pstruEventDetails->nDeviceId));
	...
	else
	{
			...
			pstruEventDetails->dEventTime))
		{
			...
			NetSim_PACKET* packet = DSR_INIT_RREQ(pstruEventDetails->pPacket->nDestinationId,
